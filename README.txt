...
5) When the user is invited and the role is granted, the invite is automatically deleted so if you see that it is active with max 2 uses do not pay attention
